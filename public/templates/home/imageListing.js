...
pug_html = pug_html + "\u003Cimg" + (pug_attr("src", image.imageUrl, true, false)+" alt=\"\" onerror=\"this.src='images\u002Fno-image.png'\"") + "\u002F\u003E\u003C\u002Fdiv\u003E";
...
;pug_debug_line = 7;pug_debug_filename = "views\u002Fclient\u002Fhome\u002FimageListing.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = image.short_description) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
